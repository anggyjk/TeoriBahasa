  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-up": "slide-in-up 0.8s ease-out forwards",
        ...
        "futsal-player": "futsal-player-enter 1s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards",
        "bg-orb": "background-orb 20s ease-in-out infinite",
      },
    },
  },
